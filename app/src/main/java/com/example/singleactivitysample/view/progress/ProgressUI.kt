package com.example.singleactivitysample.view.progress
...
@Composable
fun ProgressUI(composeNavigator: NavController) {
    ...
    Scaffold(
        ...
        topBar = {
            TopBar("Progress UI", scaffoldState, scope, composeNavigator)
        },
        bottomBar = {
            BottomBar()
        },
